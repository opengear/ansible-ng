# Opengear NG Collection
_Part of the [opengear-ansible-collections][] repository._
...
To install any collection from the source repository:
```
...
For more examples of Opengear module usage, see [Opengear Ansible Examples][opengear-ansible-examples].
...
[opengear-ansible-examples]: https://github.com/opengear/ansible-collections/tree/main/examples
[opengear-ansible-collections]: https://github.com/opengear/ansible-collections

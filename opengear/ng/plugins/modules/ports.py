...
module: ports
version_added: '1.0.0'
short_description: Manages configuration of ports on Opengear devices
description:
  - Manages configuration of ports on Opengear devices
author:
  - Opengear (@opengear)
options:
  config:
    description: Manage configuration of ports on Opengear devices
    type: dict
    suboptions:
      ports:
        type: list
...
from ansible_collections.opengear.ng.plugins.module_utils.config.ports import Ports

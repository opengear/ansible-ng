        ...
        for option in config.keys():
            if option in conf:
                if isinstance(conf[option], dict):
                    config[option] = self.render_config(spec[option], conf[option])
                    # for key in config[option].keys():
                    #     if key in conf[option]:
                    #         config[option][key] = conf[option][key]
                else:
